...
cmake .. -G Ninja \
    -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_C_COMPILER_LAUNCHER="C:\BuildTools\VC\Tools\MSVC\14.16.27023\bin\HostX86\x64" \
    -DCMAKE_CXX_COMPILER_LAUNCHER="C:\BuildTools\VC\Tools\MSVC\14.16.27023\bin\HostX86\x64" \
    -DCITRA_USE_BUNDLED_QT=1 \
    -DCITRA_USE_BUNDLED_SDL2=1 \
    -DENABLE_QT_TRANSLATION=ON \
    -DCITRA_ENABLE_COMPATIBILITY_REPORTING=OFF \
